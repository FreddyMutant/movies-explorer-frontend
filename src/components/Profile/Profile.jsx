          ...
          <form className="account__form" noValidate onSubmit={handleSubmit}>
            ...
            <div className="account__down">
              ...
              {isButtonPresent
                ...
                :
                <>
                  <button type="button" className="account__redact button-opacity" onClick={() => setIsButtonPresent(true)}>Редактировать</button>
                  <button type="button" className="account__signout button-opacity" onClick={signout}>Выйти из аккаунта</button>
                </>
              }
            </div>
          </form>
